...
df.loc[idx, "Annual_Income"] = 9999999999
...
df.loc[idx, "Transaction_Count"] = 999999
...
df.loc[idx, "Customer_Segment"] = np.nan

# Duplicate entire dataset 2x
